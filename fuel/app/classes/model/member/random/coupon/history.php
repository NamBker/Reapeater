...
class Model_Member_Random_Coupon_History extends \Model_Standard_Model
{
    ...
    protected static $_to_array_exclude = array(
        'created_at', 'updated_at', 'coupon', 'store', 'member', 'store_member', 'member_delivery_history', 'random_coupon',
    );
