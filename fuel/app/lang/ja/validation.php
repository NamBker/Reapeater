...
return array(
	...
	'required_even_empty'  => ':label は必須入力です。',
	...
	'match_pattern'        => ':label は、:param:1 で入力して下さい。',
	...
	'numeric_between'      => ':label には、:param:1 以上 :param:2 以下の数値を入力してください',
	'valid_string'         => ':label は :param:1 で入力してください。',
	'required_with'        => ':label The field :label must contain a value if :param:1 contains a value.',
