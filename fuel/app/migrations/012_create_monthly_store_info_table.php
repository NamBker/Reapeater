...
class Create_Monthly_Store_info_Table
{
    public function up()
    {
        \DBUtil::create_table(
            'monthly_store_info',
            array(
                'month' => array('type' => 'varchar', 'constraint' => 7, 'default' => '0000-00', 'comment' => '対象日(YYYY-MM)')
            ...
            array('month', 'company_id', 'brand_id', 'store_id',), true, 'InnoDB', 'utf8'
        );
    }

    public function down()
    {
        \DBUtil::drop_table('monthly_store_info');
    }
}